...
import 'tim_uikit_more_panel_pro.dart';

GlobalKey<_TIMUIKitTextFieldLayoutNarrowProState> narrowTextFieldKey =
    GlobalKey();

class TIMUIKitTextFieldLayoutNarrowPro extends StatefulWidget {
  ...
  const TIMUIKitTextFieldLayoutNarrowPro({
    super.key,
  ...
  @override
  State<TIMUIKitTextFieldLayoutNarrowPro> createState() =>
      _TIMUIKitTextFieldLayoutNarrowProState();
}

class _TIMUIKitTextFieldLayoutNarrowProState
    extends TIMUIKitState<TIMUIKitTextFieldLayoutNarrowPro> {
          ...
          ? widget.customStickerPanel!(
              ...
              addCustomEmojiText: ((String singleEmojiName) {
                ...
                if (widget.isUseDefaultEmoji &&
                    ...
                    TUIKitStickerConstData.emoji4349ZhMapList[emojiName] !=
                        null &&
                    TUIKitStickerConstData.emoji4349ZhMapList[emojiName] !=
                        '') {
                  emojiName =
  ...
  Null Function(String text) _debounce(
  ...
  Container _buildRepliedMessage(V2TimMessage? repliedMessage) {
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    if (widget.forbiddenText == null) const SizedBox(width: 10),
                    if (widget.forbiddenText == null)
                      Expanded(
                    ...
                    if (widget.showMorePanel &&
                      ...
                      InkWell(
                        ...
                        child:
                            ...
                            //         color: const Color(0xFF616166), size: 32)
                            //     :
                            SvgPicture.asset(
                              'images/add.svg',
                              package: 'tencent_cloud_chat_uikit',
