...
import 'package:tencent_cloud_chat_uikit/ui/views/TIMUIKitChat/TIMUIKItMessageList/tim_uikit_history_message_list_container.dart';
import 'package:tencent_cloud_chat_uikit/base_widgets/tim_ui_kit_base.dart';

import 'tim_uikit_text_field_pro.dart';

// import 'tim_uikit_text_field_pro.dart';

class TIMUIKitChatPro extends StatefulWidget {
  int startTime = 0;
  int endTime = 0;
  ...
  @override
  State<StatefulWidget> createState() => _TUIChatProState();
}

class _TUIChatProState extends TIMUIKitState<TIMUIKitChatPro> {
  ...
  @override
  void didUpdateWidget(TIMUIKitChatPro oldWidget) {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    final closePanel = OptimizeUtils.throttle(
      (_) => textFieldController.hideAllPanel(),
      60,
    );
    ...
    return TIMUIKitChatProviderScope(
      ...
      isBuild: isBuild,
      providers: [Provider(create: (_) => widget.config)],
      builder: (context, model, w) {
        ...
        if (widget.conversationType == ConvType.group &&
          ...
          filteredApplicationList = chatGlobalModel.groupApplicationList.where((
            item,
          ) {
        ...
        if (customImageSmallPngEmojiPackages.isEmpty) {
          customImageSmallPngEmojiPackages.addAll(
