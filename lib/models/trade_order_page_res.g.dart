...
TradeOrderItem _$TradeOrderItemFromJson(Map<String, dynamic> json) =>
    TradeOrderItem(
      ...
      buyerIsMerchant: json['buyerMerchantStatus'] as String?,
      sellerIsMerchant: json['sellerMerchantStatus'] as String?,
...
Map<String, dynamic> _$TradeOrderItemToJson(TradeOrderItem instance) =>
    <String, dynamic>{
      ...
      'buyerMerchantStatus': instance.buyerIsMerchant,
      'sellerMerchantStatus': instance.sellerIsMerchant,
