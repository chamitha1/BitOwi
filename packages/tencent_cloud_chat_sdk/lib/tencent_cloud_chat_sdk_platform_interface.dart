...
import 'models/v2_tim_group_search_result.dart';
...
abstract class TencentCloudChatSdkPlatform extends PlatformInterface {
  ...
  static TencentCloudChatSdkPlatform _instance =
      MethodChannelTencentCloudChatSdk();

  /// The default instance of [TencentCloudChatSdkPlatform] to use.
  ///
  /// Defaults to [MethodChannelTencentCloudChatSdk].
  static TencentCloudChatSdkPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [TencentCloudChatSdkPlatform] when
  /// they register themselves.
  static set instance(TencentCloudChatSdkPlatform instance) {
  ...
  void addNativeCallback() {
    throw UnimplementedError('addNativeCallback() has not been implemented.');
  }

  Future<void> emitUIKitEvent(UIKitEvent event) async {
    throw UnimplementedError('emitUIKitEvent() has not been implemented.');
  }

  Future<void> emitPluginEvent(PluginEvent event) async {
    throw UnimplementedError('emitPluginEvent() has not been implemented.');
  }
  ...
  */
  ...
  Future<LinkedHashMap<dynamic, dynamic>> getConversationListWithoutFormat({
    ...
    throw UnimplementedError(
        "getConversationListWithoutFormat() has not been implemented");
  }
  ...
  */
  ...
  Future<void> setFriendListener(
      {required V2TimFriendshipListener listener}) async {
  ...
  */
  ...
  Future<V2TimValueCallback<V2TimGroupSearchResult>> searchCloudGroups({
    ...
    throw UnimplementedError("searchCloudGroups() has not been implemented");
  }
  ...
  Future<V2TimValueCallback<V2GroupMemberInfoSearchResult>> searchCloudGroupMembers({
    ...
    throw UnimplementedError("searchCloudGroupMembers() has not been implemented");
  }
  ...
  Future<void> removeSignalingListener({
    ...
    throw UnimplementedError(
        'removeSignalingListener has not been implemented.');
  }
  ...
  Future<V2TimValueCallback<List<V2TimMessageExtensionResult>>> deleteMessageExtensions({
    ...
    throw UnimplementedError(
        'deleteMessageExtensions has not been implemented.');
  }
  ...
  Future<V2TimValueCallback<Map<String, int>>> increaseGroupCounter({
    ...
    throw UnimplementedError('increaseGroupCounter has not been implemented.');
  }
  ...
  Future<V2TimCallback> subscribeUserInfo({
    ...
    throw UnimplementedError(
      'subscribeUserInfo has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> unsubscribeUserInfo({
    ...
    throw UnimplementedError(
      'unsubscribeUserInfo has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> markGroupMemberList({
    ...
    throw UnimplementedError(
      'markGroupMemberList has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> setAllReceiveMessageOpt({
    ...
    throw UnimplementedError(
      'setAllReceiveMessageOpt has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> setAllReceiveMessageOptWithTimestamp({
    ...
    throw UnimplementedError(
      'setAllReceiveMessageOptWithTimestamp has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> addMessageReaction({
    ...
    throw UnimplementedError(
      'addMessageReaction has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> removeMessageReaction({
    ...
    throw UnimplementedError(
      'removeMessageReaction has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimMessageReactionResult>>>
    ...
    throw UnimplementedError(
      'getMessageReactions has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<V2TimMessageReactionUserResult>>
    ...
    throw UnimplementedError(
      'getAllUserListOfMessageReaction has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<V2TimMessageSearchResult>> searchCloudMessages({
    ...
    throw UnimplementedError(
      'searchCloudMessages has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimConversationOperationResult>>>
    ...
    throw UnimplementedError(
      'deleteConversationList has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<int>> getUnreadMessageCountByFilter({
    ...
    throw UnimplementedError(
      'getUnreadMessageCountByFilter has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> unsubscribeUnreadMessageCountByFilter({
    ...
    throw UnimplementedError(
      'unsubscribeUnreadMessageCountByFilter has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> cleanConversationUnreadMessageCount({
    ...
    throw UnimplementedError(
      'cleanConversationUnreadMessageCount has not been implemented.',
    );
  }
  ...
  Future<void> uikitTrace({
    ...
    throw UnimplementedError(
      'uikitTrace has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> setOfflinePushConfig({
    ...
    throw UnimplementedError(
      'setOfflinePushConfig has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimFollowTypeCheckResult>>> checkFollowType({
    ...
    throw UnimplementedError(
      'checkFollowType has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> pinGroupMessage({
    ...
    throw UnimplementedError(
      'pinGroupMessage has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimMessage>>> getPinnedGroupMessageList({
    ...
    throw UnimplementedError(
      'getPinnedGroupMessageList has not been implemented.',
    );
  }
  ...
  String addUIKitListener({
    ...
    throw UnimplementedError(
      'addUIKitListener has not been implemented.',
    );
  }
  ...
  void removeUIKitListener({
    ...
    throw UnimplementedError(
      'removeUIKitListener has not been implemented.',
    );
  }
  ...
  void emitUIKitListener({
    ...
    throw UnimplementedError(
      'emitUIKitListener has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<V2TimMessage>> createAtSignedGroupMessage({
    ...
    throw UnimplementedError(
      'createAtSignedGroupMessage has not been implemented.',
    );
  }
  ...
  Future<String> addCommunityListener({
    ...
    throw UnimplementedError(
      'addCommunityListener has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<String>> createPermissionGroupInCommunity({
    ...
    throw UnimplementedError(
      'createPermissionGroupInCommunity has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimPermissionGroupOperationResult>>>
    ...
    throw UnimplementedError(
      'deletePermissionGroupFromCommunity has not been implemented.',
    );
  }
  ...
  Future<V2TimCallback> modifyPermissionGroupInfoInCommunity({
    ...
    throw UnimplementedError(
      'modifyPermissionGroupInfoInCommunity has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimPermissionGroupInfoResult>>>
    ...
    throw UnimplementedError(
      'getJoinedPermissionGroupListInCommunity has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimPermissionGroupInfoResult>>>
    ...
    throw UnimplementedError(
      'getPermissionGroupListInCommunity has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimPermissionGroupMemberOperationResult>>>
    ...
    throw UnimplementedError(
      'removeCommunityMembersFromPermissionGroup has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<V2TimPermissionGroupMemberInfoResult>>
    ...
    throw UnimplementedError(
      'getCommunityMemberListInPermissionGroup has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimTopicOperationResult>>>
    ...
    throw UnimplementedError(
      'addTopicPermissionToPermissionGroup has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimTopicOperationResult>>>
    ...
    throw UnimplementedError(
      'deleteTopicPermissionFromPermissionGroup has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimTopicOperationResult>>>
    ...
    throw UnimplementedError(
      'modifyTopicPermissionInPermissionGroup has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<List<V2TimTopicPermissionResult>>>
    ...
    throw UnimplementedError(
      'getTopicPermissionInPermissionGroup has not been implemented.',
    );
  }
  ...
  Future<V2TimValueCallback<String>> createCommunity({
    ...
    throw UnimplementedError(
      'V2TimCreateGroupMemberInfo has not been implemented.',
    );
  }
}
