  ...
  V2TimValueCallback.fromJson(Map json) {
    ...
    if (json['json_param'] == null) {
      ...
      if (result.isNotEmpty && T != String) {
        ...
        } else if (T == V2TimGroupSearchResult) {
          fromJsonData = V2TimGroupSearchResult.fromJson(jsonParam) as T;
        } else if (T == V2GroupMemberInfoSearchResult) {
          // 这里只处理云端搜索群成员结果
          fromJsonData = V2GroupMemberInfoSearchResult.fromJsonForCloudSearch(jsonParam);
        ...
        } else if (T == V2TimUserSearchResult) {
          fromJsonData = V2TimUserSearchResult.fromJson(jsonParam);
  ...
  String toLogString() {
    ...
    if (this.data == null) {
      ...
      if (T == V2TimMessage) {
        ...
        res +=
            json.encode((this.data as List).map((e) => (e as V2TimOfficialAccountInfoResult).toLogString()).toList());
      } else if (T == _getT<List<V2TimPermissionGroupMemberOperationResult>>()) {
        res += json.encode(
            (this.data as List).map((e) => (e as V2TimPermissionGroupMemberOperationResult).toLogString()).toList());
      } else if (T == _getT<List<V2TimPermissionGroupOperationResult>>()) {
        res += json
            .encode((this.data as List).map((e) => (e as V2TimPermissionGroupOperationResult).toLogString()).toList());
      } else if (T == _getT<List<V2TimTopicPermissionResult>>()) {
        ...
        res +=
            json.encode((this.data as List).map((e) => (e as V2TimGroupMemberOperationResult).toLogString()).toList());
      } else if (T == V2TimGroupApplicationResult) {
        ...
        res +=
            json.encode((this.data as List).map((e) => (e as V2TimPermissionGroupInfoResult).toLogString()).toList());
      } else if (T == _getT<List<V2TimConversationOperationResult>>()) {
        res +=
            json.encode((this.data as List).map((e) => (e as V2TimConversationOperationResult).toLogString()).toList());
      } else if (T == V2TimReceiveMessageOptInfo) {
        res += (this.data as V2TimReceiveMessageOptInfo).toLogString();
      } else if (T == V2TimMessageReactionResult) {
